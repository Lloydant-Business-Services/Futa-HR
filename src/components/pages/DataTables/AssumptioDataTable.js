      ...
      <div className="card">
        <div className="card-body">
          ...
          <span className="text-sm">Download/Export: </span>
            ...
            <button className="btn btn-outline-primary" onClick={() => this.exportPDF()}><i className="fa fa-file-pdf-o"/> &nbsp; PDF (Documentation)</button> 
            <button className="btn  btn-outline-success custom-success" onClick={() => this.exportPDFPosting()}><i className="fa fa-paperclip"/> &nbsp; PDF (Post Copy)</button> 
            <hr className="my-3" />
