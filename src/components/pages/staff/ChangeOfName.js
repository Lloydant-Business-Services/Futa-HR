                    ...
                    <div className="table-responsive">
                      <table className="table table-striped sofia">
                        ...
                        <tbody>
                          ...
                          <td>{i.isApproved && i.isClosed ? null : <Link to={{pathname:"ViewChangeOfName", state:{data:i}}}><button className="btn btn-outline-primary btn-sm">View Request <i className="fa fa-eye"/></button></Link>}</td>
