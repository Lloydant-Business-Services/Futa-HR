            ...
            <div className="col-md-6">
              <div className="card px-3">
                ...
                <div className="card bg-lighter3 id-card" id="IDcard">
                  <div className="card-header py-2" style={{backgroundColor:"rgb(82 96 129)"}}>
                  ...
                  <div
                    className="bg-accent"
                    style={{ backgroundColor: "rgb(162 156 161)", minHeight: "5px" }}
                  ></div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-8">
                        ...
                        <div className="my-2">
                          ...
                          <div className="card-serial-number h4 sofia">
                            <div>
                  ...
                  <div className="card-footer text-center bg-lighter">
                    <span className="h6 text-muted">
                      Balogun-Femi Expressway, Odogwu Road, Akure
                    </span>
                  </div>
                </div>
              </div>
