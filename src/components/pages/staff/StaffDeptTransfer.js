                    ...
                    <div className="table-responsive">
                      <table className="table table-striped sofia">
                        ...
                        <tbody>
                          ...
                          <td>{i.isApproved && i.isClosed ? null : <Link to={{pathname:"DepartmentTransferLetter", state:{data:i}}}><button className="btn btn-outline-primary btn-sm"> <i className="fa fa-eye"/></button></Link>}</td>
            ...
            <Modal isOpen={this.state.makeRequest}>
              {/* <div className="modal-content mdal2"> */}
                ...
                <div className="modal-body">
                  ...
                  >
                    Make Transfer Request &nbsp;<i className="fa fa-send"/>
                  </button>
                {/* </div> */}
              </div>
            </Modal>
