      ...
      (data) => {
        ...
        let mappedStaff = data.map((d, i) => {
          ...
          return {
            ...
            sn: i + 1,
            name: d.staffName,
            staffIdentityNumber: d.staffNumber,
            ...
            <div className="row mb-4">
              <div className="col">
                <h1 className="d-inline-block mb-0 pop-font">
                  Assumption Of Duty{" "}
                  <span className="h3 text-muted">/ Pull List</span>
                </h1>
                ...
                {/* <div className="col-md-6 text-center"> */}
                  ...
                  <div className="col-md-5">
                    ...
                    <div className="row col-md-5" style={{marginLeft:"75px"}}>
                        <button className="btn btn-outline-primary btn-sm" onClick={this.filterStaff}>Load List</button>
                    </div>
