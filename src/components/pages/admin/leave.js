      ...
      {this.state.spin ? <Spinner/> : null}
        ...
        <Modal isOpen={this.state.added}>
          <ModalBody>
            ...
            <h3 className="text-center sofia">Added Successfully!</h3>
          </ModalBody>
          <ModalFooter>
            <button
        ...
        <Modal isOpen={this.state.addLeaveCard} style={{ maxWidth: "700px" }}>
          ...
          >
            ...
            <button className="btn btn-outline-danger" onClick={this.toggleLeaveCard}>
              Cancel
            </button>
          </ModalFooter>
        </Modal>
                      ...
                      <div className="form-group col-md-10">
                        <div className="row justify-content-center">
                          ...
                          <div className="col-md-2">
                            <span
                              className=" btn btn-outline-primary mt-3rem"
