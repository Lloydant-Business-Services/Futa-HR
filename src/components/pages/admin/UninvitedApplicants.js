...
export default class UninvitedApplicants extends React.Component {
  ...
  handleSubmit = e => {
    ...
    postData("/ApplicationForms/ApplicantInvitation", applicantPayload, data => {
      console.log({ data })
    ...
    return (
      ...
      <div className="header-body">
        ...
        <button type="button" class="btn btn-outline-primary"
          ...
          Invite Selected Applicants &nbsp;<i className="fa fa-check"/>
        </button>
        ...
        <form onSubmit={e => this.handleSubmit(e)}>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button onClick={this.handleSubmit} class="btn btn-outline-primary">
