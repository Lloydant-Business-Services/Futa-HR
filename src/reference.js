...
{/* <PDFViewer url={eee} /> */}
      ...
      <Image src={logosm}/>
       ...
       <View style={{position:"absolute", top:"20", left:"50", zIndex:"900"}}>
           ...
           <Text className="water-mark" style={{marginBottom:"10px", opacity:"0.3"}}>FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE</Text>
            <Text className="water-mark" style={{marginBottom:"10px", opacity:"0.3"}}>FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE</Text>
            <Text className="water-mark" style={{marginBottom:"10px", opacity:"0.3"}}>FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE</Text>
            <Text className="water-mark" style={{marginBottom:"10px", opacity:"0.3"}}>FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE</Text>
            <Text className="water-mark" style={{marginBottom:"10px", opacity:"0.3"}}>FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE &nbsp; FEDERAL UNIVERSITY OF TECHNOLOGY AKURE</Text>
