...
export default class NewForm extends React.Component {
  ...
  submitApplication = (e) => {
    e.preventDefault();
    this.setState({ spin: true, confirmCard:false });
      ...
      <>
        <Modal isOpen={this.state.confirmCard}>
          <ModalBody>
            ...
            <h3 className="text-center sofia">Confirm Submission?</h3>
          </ModalBody>
          <ModalFooter>
            <button
        ...
        <Modal isOpen={this.state.success}>
            <ModalBody>
    <ModalHeader className="text-secondary"><span className="badge badge-danger"></span></ModalHeader>
    <div className="row justify-content-center">
              <img src={checkIcon2} style={{width:"50px"}}/>
              </div>

                    <h3 className="text-center sofia">Your Application was successfully submitted for due consideration! <br/><br/>Details and status of this application would be communicated to you via the email provided. <br/> <br/>Do well to check your registered email as often as possible to stay informed. Thank you!</h3>
                </ModalBody>
                        <ModalFooter>
                                <button className="btn btn-outline-primary" onClick={this.closeSuccess}>
                                    OK
                                </button> 
            ...
            <div className="row align-items-center py-4">
              <div className="col-lg-12 col-7">
                <h6 className="h1 d-inline-block mb-0 pop-font">
                  Job Position{" : "} ({this.state.jobName})
                </h6>
              </div>
            </div>
                  ...
                  <div className="table-responsive">
                    ...
                    <fieldset className="form-widget">
                      ...
                      <div className="border-bottom">
                        <div className="form-group text-left">
                          <h5>
                            Do you have journals or other published works? &nbsp;
                          </h5>
                          <h5>
                            <label
                    ...
                    <fieldset className="form-widget">
                      ...
                      <div className="border-bottom">
                        <div className="form-group text-left">
                          <h5>Do you have previous work experiences? &nbsp;</h5>
                          {/* <h5>
                            <label
                              className="custom-toggle"
                    ...
                    <fieldset className="form-widget">
                      ...
                      <div className="border-bottom">
                        <div className="form-group text-left">
                          <h5>Have you at any point obtained research grants? &nbsp;</h5>
                          {/* <h5>
                            <label
                              className="custom-toggle"
                    ...
                    <fieldset className="form-widget">
                      ...
                      <div className="border-bottom">
                        <div className="form-group text-left">
                          <h5>
                            Have you obtained any professional qualification(s)? &nbsp;
                          </h5>
                          {/* <h5>
                            <label
                              className="custom-toggle"
                    ...
                    <fieldset className="form-widget">
                      ...
                      >
                        Submit Application <i className="fa fa-send"/>
                      </button>
                    </fieldset>
