    ...
    return (
      <>
        ...
        >
			<div className="container">
				...
				<ul className="navbar-nav align-items-center ml-md-auto">
					...
					{/* <Link className="nav-link" to="/login"> */}
						...
						<Button className="btn btn-outline-primary" to="/Home" color={"secondary"} tag={Link}>
							Home
						</Button>
					{/* </Link> */}
					</li>
			...
			<section className="pb-5 pr-2 pl-2 overflow-hidden shadow-sm hero" style={{backgroundColor:"darkmagenta"}}>
			<div className="container">
